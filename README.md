...
friendly_fire__<class>__<damage type> | integer | sets special teamkill amount for classname: `ci | mtf | sci | classd` and `damamage type` - lower case of type of damage from [Smod2 Wiki](https://github.com/Grover-c13/Smod2/wiki/Enum-Lists#damagetype)
